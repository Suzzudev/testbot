...
module.exports = {
    name: 'play',
    description: 'Joins and plys music',
    async execute(msg, args) {
        const voiceChannel = msg.member.voice.channel;

        if(!voiceChannel) return msg.channel.send('You need to be in a voice chat');
        ...
        if(!args.length) return msg.channel.send('You need another argument');
